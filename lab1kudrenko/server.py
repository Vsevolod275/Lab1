...
class Handler(BaseHTTPRequestHandler):
    def do_GET(self):
        ...
        if path == '/':
            self.render_template('index.html', {'title': 'Главная - Сдача автомобилей в аренду'})
        elif path == '/about/':
            self.render_template('about.html', {'title': 'О нас - Сдача автомобилей в аренду'})
        elif path == '/catalog/':
            cars = {
            ...
            self.render_template('catalog.html', {'title': 'Каталог - Автомобили в аренду', 'cars': cars})
        else:
            self.send_error(404)
